...
public class Main {
	...
	public static void main(String[] args) {
		...
		Arrays.sort(array);
		System.out.println("Original array sorted by objection: " + Arrays.toString(array));

		Arrays.sort(array, Collections.reverseOrder());
		System.out.println("Original array sorted in descending order: " + Arrays.toString(array));
